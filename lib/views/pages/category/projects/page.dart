...
import 'package:dashboard/views/pages/category/projects/detail.dart';
...
class ProjectsPage extends StatefulWidget {
  const ProjectsPage({final Key? key}) : super(key: key);

  @override
  State<ProjectsPage> createState() => _ProjectsPageState();
}

class _ProjectsPageState extends State<ProjectsPage> with ProjectsController {
  @override
  void initState() {
    initApp(
      action: () => setState(() {}),
        ...
        appBar: appbar(
          ...
          actions: <Widget>[
            ...
            IconButton(
              ...
              onPressed: () async {
                final String? res = await Get.to(const ProjectsDetailPage());
