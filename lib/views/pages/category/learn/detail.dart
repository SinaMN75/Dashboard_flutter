...
class LearnDetailPage extends StatefulWidget {
  const LearnDetailPage({this.category, final Key? key}) : super(key: key);
...
class _LearnDetailPageState extends State<LearnDetailPage> with LearnController {
  ...
  Widget build(final BuildContext context) => scaffold(
        ...
        appBar: appbar(title: widget.category!=null?s.updateLearn:s.createLearn),
        body: Stack(
          children: <Widget>[
            Positioned.fill(
              child: Image.asset(
                ...
                child: Center(
                  child: Form(
                    ...
                    child: column(
                      ...
                      isScrollable: true,
                      children: <Widget>[
                        Text(widget.category != null ? s.updateLearn : s.createLearn).headline6(fontSize: 24, fontWeight: FontWeight.bold).marginSymmetric(vertical: 16, horizontal: 8),
                        Container(
