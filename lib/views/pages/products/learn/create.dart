...
class LearnCreatePage extends StatefulWidget {
  const LearnCreatePage({required this.onBack, this.product, final Key? key}) : super(key: key);
  final ProductReadDto? product;
  final VoidCallback onBack;
  @override
  State<LearnCreatePage> createState() => _LearnCreatePageState();
}

class _LearnCreatePageState extends State<LearnCreatePage> with LearnProductController {
