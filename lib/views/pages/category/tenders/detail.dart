...
class _TendersDetailPageState extends State<TendersDetailPage> with TendersController {
  ...
  Widget build(final BuildContext context) => scaffold(
        ...
        appBar: appbar(title: widget.category!=null?s.updateTenders:s.createTenders),
        body: Stack(
          children: <Widget>[
            Positioned.fill(
              child: Image.asset(
                ...
                child: Center(
                  child: Form(
                    ...
                    child: column(
                      ...
                      isScrollable: true,
                      children: <Widget>[
                        Text(widget.category != null ? s.updateTenders : s.createTenders).headline6(fontSize: 24, fontWeight: FontWeight.bold).marginSymmetric(vertical: 16, horizontal: 8),
                        Container(
