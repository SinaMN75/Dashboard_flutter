...
import 'package:dashboard/views/pages/category/daily_price/detail.dart';
...
class DailyPricePage extends StatefulWidget {
  const DailyPricePage({final Key? key}) : super(key: key);

  @override
  State<DailyPricePage> createState() => _DailyPricePageState();
}

class _DailyPricePageState extends State<DailyPricePage> with DailyPriceController {
  @override
  void initState() {
    initApp(
      action: () => setState(() {}),
        ...
        appBar: appbar(
          ...
          actions: <Widget>[
            ...
            IconButton(
              ...
              onPressed: () async {
                final String? res = await Get.to(const DailyPriceDetailPage());
