...
class JobsPage extends StatefulWidget {
  const JobsPage({final Key? key}) : super(key: key);

  @override
  State<JobsPage> createState() => _JobsPageState();
}

class _JobsPageState extends State<JobsPage> with JobsController {
  @override
  void initState() {
    initApp(
      action: () => setState(() {}),
        ...
        appBar: appbar(
          ...
          actions: <Widget>[
            ...
            IconButton(
              ...
              onPressed: () async {
                final String? res = await Get.to(const JobsDetailPage());
