...
class AdsPage extends StatefulWidget {
  const AdsPage({final Key? key}) : super(key: key);

  @override
  State<AdsPage> createState() => _AdsPageState();
}

class _AdsPageState extends State<AdsPage> with AdsController {
  @override
  void initState() {
    initApp(
      action: () => setState(() {}),
        ...
        appBar: appbar(
          ...
          actions: <Widget>[
            ...
            IconButton(
              ...
              onPressed: () async {
                final String? res = await Get.to(const AdsDetailPage());
