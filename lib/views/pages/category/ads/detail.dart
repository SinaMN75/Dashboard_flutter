...
import 'package:dashboard/views/pages/category/ads/controller.dart';
...
class _AdsDetailPageState extends State<AdsDetailPage> with AdsController {
  ...
  Widget build(final BuildContext context) => scaffold(
        ...
        appBar: appbar(title: widget.category!=null?s.updateAds:s.createAds),
        body: Stack(
          children: <Widget>[
            Positioned.fill(
              child: Image.asset(
                ...
                child: Center(
                  child: Form(
                    ...
                    child: column(
                      ...
                      isScrollable: true,
                      children: <Widget>[
                        Text(widget.category != null ? s.updateAds : s.createAds).headline6(fontSize: 24, fontWeight: FontWeight.bold).marginSymmetric(vertical: 16, horizontal: 8),
                        Container(
