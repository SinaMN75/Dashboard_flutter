...
class UserCustomAppDown extends StatefulWidget {
  UserCustomAppDown({required this.selectCase, final Key? key}) : super(key: key);

  Function(String selectMediaUseCase) selectCase;

  @override
  State<UserCustomAppDown> createState() => _UserCustomAppDownState();
}

class _UserCustomAppDownState extends State<UserCustomAppDown> {
