...
import 'package:dashboard/views/pages/products/magazine/create.dart';
...
class MagazineProductPage extends StatefulWidget {
  const MagazineProductPage({final Key? key}) : super(key: key);

  @override
  State<MagazineProductPage> createState() => _MagazineProductPageState();
}

class _MagazineProductPageState extends State<MagazineProductPage> with MagazineProductController {
  @override
  void initState() {
        ...
        appBar: appbar(
          ...
          actions: <Widget>[
            ...
            IconButton(
              ...
              onPressed: () => push(
                MagazineCreatePage(onBack: () => getProducts(action: () => dataSource.value = DataSource(list))),
              ),
            ),
          ],
        ),
