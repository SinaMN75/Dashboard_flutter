...
import 'package:dashboard/views/pages/category/projects/controller.dart';
...
class ProjectsDetailPage extends StatefulWidget {
  const ProjectsDetailPage({this.category, final Key? key}) : super(key: key);
...
class _ProjectsDetailPageState extends State<ProjectsDetailPage> with ProjectsController {
  ...
  Widget build(final BuildContext context) => scaffold(
        ...
        appBar: appbar(title: widget.category!=null?s.updateProjects:s.createProjects),
        body: Stack(
          children: <Widget>[
            Positioned.fill(
              child: Image.asset(
                ...
                child: Center(
                  child: Form(
                    ...
                    child: column(
                      ...
                      isScrollable: true,
                      children: <Widget>[
                        Text(widget.category != null ? s.updateProjects : s.createProjects).headline6(fontSize: 24, fontWeight: FontWeight.bold).marginSymmetric(vertical: 16, horizontal: 8),
                        Container(
