...
class MagazineDetailPage extends StatefulWidget {
  const MagazineDetailPage({this.category, final Key? key}) : super(key: key);
...
class _MagazineDetailPageState extends State<MagazineDetailPage> with MagazineController {
  ...
  Widget build(final BuildContext context) => scaffold(
        ...
        appBar: appbar(title: widget.category!=null?s.updateMagazine:s.createMagazine),
        body: Stack(
          children: <Widget>[
            Positioned.fill(
              child: Image.asset(
                ...
                child: Center(
                  child: Form(
                    ...
                    child: column(
                      ...
                      isScrollable: true,
                      children: <Widget>[
                        Text(widget.category != null ? s.updateMagazine : s.createMagazine).headline6(fontSize: 24, fontWeight: FontWeight.bold).marginSymmetric(vertical: 16, horizontal: 8),
                        Container(
